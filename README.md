...
> **Note:** Topology diagrams and detailed documentation are automatically generated when you run `ansible-playbook build.yml`. The generated documentation will be available in the `documentation/` directory and will reflect your exact configuration.
>
> - `documentation/fabric/` - Fabric-wide topology, P2P links, and network design
> - `documentation/devices/` - Per-device configuration documentation

This repository implements a dual data center L3 leaf-spine architecture with:
- **DC1 & DC2**: Each with 2 spine switches, 2 L3 leaf switches, and 2 border leaf switches
- **EVPN/VXLAN**: Overlay network with symmetric IRB
- **DCI Links**: Border leaves interconnect the data centers using EVPN DC Gateway functionality
